...
# docker exec -it yorkiebakery-api_db_1 psql -U postgres -d yorkiebakery -f /migrations/001_create_tables.sql
# docker exec -it yorkiebakery-api_db_1 psql -U postgres -d yorkiebakery -f /migrations/002_seed_menu.sql
